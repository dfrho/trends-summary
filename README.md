...
Search by State Trends is a web application that visualizes and summarizes Google search trends by state in the United States. Our goal was to create a functional MVP that could:
